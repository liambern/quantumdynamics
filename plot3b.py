...
ax.plot(L_diag-fermi, rho_0_L, c='red', label='L_0')
ax.plot(L_diag, L, c='red', label='L', ls='--')
ax.plot(R_diag-fermi, rho_0_R, c='blue', label='R_0')
ax.plot(R_diag, R,c='blue', label='R', ls='--')
ax.legend()
# ax.scatter(M_diag, M)
# ax.plot(EM_diag, EM)
